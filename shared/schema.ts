...
export const applications = pgTable('applications', {
  ...
  grit_app_id: varchar('grit_app_id', { length: 50 }).unique(),
  application_type: varchar('application_type', { length: 50 }).default('nclex'),
  service_type: varchar('service_type', { length: 100 }),
  service_state: varchar('service_state', { length: 100 }),
  ...
  single_full_name: varchar('single_full_name', { length: 255 }),
  spouse_name: varchar('spouse_name', { length: 255 }),
  spouse_email: varchar('spouse_email', { length: 255 }),
  spouse_contact: varchar('spouse_contact', { length: 50 }),
  date_of_birth: varchar('date_of_birth', { length: 50 }),
  birth_place: varchar('birth_place', { length: 255 }),
  country_of_birth: varchar('country_of_birth', { length: 100 }),
  house_number: varchar('house_number', { length: 100 }),
  street_name: varchar('street_name', { length: 255 }),
  city: varchar('city', { length: 100 }),
  province: varchar('province', { length: 100 }),
  country: varchar('country', { length: 100 }),
  zipcode: varchar('zipcode', { length: 20 }),
  elementary_school: varchar('elementary_school', { length: 255 }),
  elementary_city: varchar('elementary_city', { length: 100 }),
  elementary_province: varchar('elementary_province', { length: 100 }),
  elementary_country: varchar('elementary_country', { length: 100 }),
  elementary_years_attended: varchar('elementary_years_attended', { length: 50 }),
  elementary_start_date: varchar('elementary_start_date', { length: 50 }),
  elementary_end_date: varchar('elementary_end_date', { length: 50 }),
  high_school: varchar('high_school', { length: 255 }),
  high_school_city: varchar('high_school_city', { length: 100 }),
  high_school_province: varchar('high_school_province', { length: 100 }),
  high_school_country: varchar('high_school_country', { length: 100 }),
  high_school_years_attended: varchar('high_school_years_attended', { length: 50 }),
  high_school_start_date: varchar('high_school_start_date', { length: 50 }),
  high_school_end_date: varchar('high_school_end_date', { length: 50 }),
  high_school_graduated: varchar('high_school_graduated', { length: 20 }),
  high_school_diploma_type: varchar('high_school_diploma_type', { length: 100 }),
  high_school_diploma_date: varchar('high_school_diploma_date', { length: 50 }),
  nursing_school: varchar('nursing_school', { length: 255 }),
  nursing_school_city: varchar('nursing_school_city', { length: 100 }),
  nursing_school_province: varchar('nursing_school_province', { length: 100 }),
  nursing_school_country: varchar('nursing_school_country', { length: 100 }),
  nursing_school_years_attended: varchar('nursing_school_years_attended', { length: 50 }),
  nursing_school_start_date: varchar('nursing_school_start_date', { length: 50 }),
  nursing_school_end_date: varchar('nursing_school_end_date', { length: 50 }),
  nursing_school_major: varchar('nursing_school_major', { length: 100 }),
  nursing_school_diploma_date: varchar('nursing_school_diploma_date', { length: 50 }),
  picture_path: text('picture_path'),
  diploma_path: text('diploma_path'),
  passport_path: text('passport_path'),
...
export const applicationPayments = pgTable('application_payments', {
  ...
  stripe_payment_method_id: varchar('stripe_payment_method_id', { length: 255 }),
  payment_method: varchar('payment_method', { length: 50 }).default('stripe'),
  transaction_id: varchar('transaction_id', { length: 255 }),
  proof_of_payment_file_path: text('proof_of_payment_file_path'),
  gcash_reference_number: varchar('gcash_reference_number', { length: 100 }),
  gcash_account_name: varchar('gcash_account_name', { length: 255 }),
  gcash_receipt_url: text('gcash_receipt_url'),
  usd_to_php_rate: decimal('usd_to_php_rate', { precision: 8, scale: 4 }),
...
export const newsletterSubscriptions = pgTable('newsletter_subscriptions', {
  ...
  subscription_type: varchar('subscription_type', { length: 50 }).default('newsletter'),
  is_active: boolean('is_active').default(true),
