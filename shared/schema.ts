...
export const users = pgTable('users', {
  ...
  mobile: varchar('mobile', { length: 50 }).unique(),
  grit_id: varchar('grit_id', { length: 50 }).unique(),
  gritsync_email: varchar('gritsync_email', { length: 255 }).unique(),
...
export const userDetails = pgTable('user_details', {
  ...
  date_of_birth: varchar('date_of_birth', { length: 20 }),
  ...
  elementary_city: varchar('elementary_city', { length: 255 }),
  elementary_province: varchar('elementary_province', { length: 255 }),
  elementary_country: varchar('elementary_country', { length: 255 }),
  elementary_years_attended: varchar('elementary_years_attended', { length: 50 }),
  elementary_start_date: varchar('elementary_start_date', { length: 20 }),
  elementary_end_date: varchar('elementary_end_date', { length: 20 }),
  high_school: varchar('high_school', { length: 255 }),
  high_school_city: varchar('high_school_city', { length: 255 }),
  high_school_province: varchar('high_school_province', { length: 255 }),
  high_school_country: varchar('high_school_country', { length: 255 }),
  high_school_years_attended: varchar('high_school_years_attended', { length: 50 }),
  high_school_start_date: varchar('high_school_start_date', { length: 20 }),
  high_school_end_date: varchar('high_school_end_date', { length: 20 }),
  nursing_school: varchar('nursing_school', { length: 255 }),
  nursing_school_city: varchar('nursing_school_city', { length: 255 }),
  nursing_school_province: varchar('nursing_school_province', { length: 255 }),
  nursing_school_country: varchar('nursing_school_country', { length: 255 }),
  nursing_school_years_attended: varchar('nursing_school_years_attended', { length: 50 }),
  nursing_school_start_date: varchar('nursing_school_start_date', { length: 20 }),
  nursing_school_end_date: varchar('nursing_school_end_date', { length: 20 }),
  nursing_school_major: varchar('nursing_school_major', { length: 255 }),
  nursing_school_diploma_date: varchar('nursing_school_diploma_date', { length: 20 }),
