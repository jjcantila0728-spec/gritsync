...
export const NclexReview = () => {
  ...
  const resultsUrl = `${MAIN_SITE}/nclex/results/${sessionId}`;
  const homeUrl = `${MAIN_SITE}/nclex`;
  ...
  if (!session) return (
    <NclexLayout backTo={homeUrl}>
      <div className="max-w-2xl mx-auto px-4 py-12 text-center">
        <p className="text-gray-500">Session not found.</p>
        <a href={homeUrl} className="mt-4 inline-block text-blue-600 underline text-sm">Return home</a>
      </div>
    </NclexLayout>
  );
      ...
      <div className="flex h-[calc(100vh-56px)] overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between flex-shrink-0">
            <a href={resultsUrl} className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700">
