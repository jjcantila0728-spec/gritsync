                ...
                <div className="space-y-4 sticky top-6">
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-900">
                      <div dangerouslySetInnerHTML={{ __html: sanitizeHTML(editingSignature?.signature_html || '<p class="text-gray-400">No signature content yet</p>') }} />
                    </div>
                  </div>
                ...
                {signatures.map(sig => (
                  ...
                  >
                    ...
                    <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 mb-4 bg-gray-50 dark:bg-gray-900 max-h-40 overflow-auto">
                      <div dangerouslySetInnerHTML={{ __html: sanitizeHTML(sig.signature_html) }} className="text-sm" />
                    </div>
