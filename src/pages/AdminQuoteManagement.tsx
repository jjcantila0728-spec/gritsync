...
export function AdminQuoteManagement() {
  ...
  const filteredQuotations = useMemo(() => {
    return quotations.filter(quote => {
      const matchesSearch = 
        quote.id.toLowerCase().includes(debouncedSearchTerm.toLowerCase()) ||
        quote.description.toLowerCase().includes(debouncedSearchTerm.toLowerCase()) ||
        quote.client_email?.toLowerCase().includes(debouncedSearchTerm.toLowerCase()) ||
        `${quote.client_first_name} ${quote.client_last_name}`.toLowerCase().includes(debouncedSearchTerm.toLowerCase())
