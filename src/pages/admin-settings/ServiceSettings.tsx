      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {SERVICE_TYPE_OPTIONS.map((service) => {
            ...
            return (
              <Card key={service.value} className="p-3 sm:p-4">
                ...
                {entries.length === 0 ? (
                  ...
                  <div className="space-y-2.5">
                    {entries.map((doc) => (
                      <div
                        key={doc.id}
                        className="flex flex-col gap-2 border border-dashed border-gray-200 dark:border-gray-700 rounded-lg p-2.5 sm:p-3"
                      >
