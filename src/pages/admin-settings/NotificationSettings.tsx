    ...
    <div className="space-y-4">
      <div className="space-y-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
        ...
        {settings.emailServiceProvider === 'resend' && (
          <div className="rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-xs text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-800 dark:text-gray-200">Resend API key:</span>{' '}
            sourced from the server&apos;s <code className="px-1 py-0.5 rounded bg-gray-100 dark:bg-gray-700 font-mono text-[11px]">RESEND_API_KEY</code> environment variable. Edit your <code className="px-1 py-0.5 rounded bg-gray-100 dark:bg-gray-700 font-mono text-[11px]">.env</code> file and restart the server to change it.
          </div>
        )}
