...
import { FileText, ArrowLeft, Shield, Scale, AlertCircle, CheckCircle, Info, BookOpen } from 'lucide-react'
...
export function TermsOfService() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Hero Banner */}
      <section className="relative py-16 overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800">
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link to="/privacy-policy" className="text-sm text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-1">
